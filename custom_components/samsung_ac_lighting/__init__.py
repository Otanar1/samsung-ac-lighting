...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    try:
        ...
        # Se der erro de auth aqui, poderíamos pedir reauth, mas vamos deixar falhar por enquanto
        await session.close()
    ...
    # Adiciona o ouvinte para atualizações (quando o usuário clica em Configurar)
...
async def update_listener(hass: HomeAssistant, entry: ConfigEntry):
    """Recarrega a integração quando as opções (ou dados) mudam."""
